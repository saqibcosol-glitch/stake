...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    primary: 'bg-solana-gradient text-white hover:shadow-glow active:scale-95',
    secondary: 'bg-solana-darkGray text-white border border-solana-purple/30 hover:border-solana-purple hover:shadow-glow',
